...
#### Add the container to the backup list ####

backup_list=/home/${USER}/mc_bedrock_server/backups/backup_list.conf
echo "Adding container to the backup list..."
echo "$container_name" >> backup_list
echo "done."
